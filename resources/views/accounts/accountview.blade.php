    ...
    <div class="col-xl-12 order-xl-0">
      <div class="card bg-secondary shadow pull-up">
        <div class="card-body">
          ...
          <div class="pl-lg-4"> @if (\Session::has('success')) <div class="alert alert-dark text-center">
              <ul>
      ...
      <div class="modal-body p-2">
        <div class="card bg-secondary shadow border-0">
          <div class="card-body px-lg-5 py-lg-5">
            ...
            <form role="form" method="POST" action="/accounts/{{ $account->account_id }}"> @method('PATCH') @csrf <div class="form-group mb-3">
...
<div class="modal fade" id="delete-account" tabindex="-1" role="dialog" aria-labelledby="modal-notification" aria-hidden="true">
  <div class="modal-dialog modal-danger modal-dialog-centered modal-" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form method="POST" action="/accounts/{{ $account->account_id }}"> @method('DELETE') @csrf <input type="hidden" name="id" value="{{$account['account_id']}}">
